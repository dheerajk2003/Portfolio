    ...
    return (
        <div id="skills" className="w-full h-screen pt-14">
            ...
            <div className="w-full h-full m-x-auto pt-28 p-5 md:p-24 md:pt-32 grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-28">
                ...
                <div className="w-[40vw] h-[40vw] md:w-[15vw] md:h-[15vw] rounded-3xl border border-1 border-white    overflow-hidden relative innerdiv shaBox"><img className="scale-75" src="./svgs/c-sharp.svg" alt="" />
                    <div className="absolute w-full h-full top-0 left-0 bg-slate-200 flex flex-col justify-center items-center child translate-y-full transition-transform">
                ...
                <div className="w-[40vw] h-[40vw] md:w-[15vw] md:h-[15vw] rounded-3xl border border-1 border-white overflow-hidden relative innerdiv shaBox"><img className="scale-75" src="./svgs/css.svg" alt="" />
                    <div className="absolute w-full h-full top-0 left-0 bg-slate-200 flex flex-col justify-center items-center child translate-y-full transition-transform">
