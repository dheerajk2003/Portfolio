        ...
        <div id="projects" className="w-full h-screen pt-14">
            ...
            <div className="w-full h-full p-20 flex justify-around items-center">
                <div className="w-1/3 h-4/5 m-5 border border-1 border-white rounded-2xl overflow-hidden">
                    <img className="w-full content" src="./recipe.jpg" alt="" />
                    <div className="h-1/2 px-5 flex flex-col justify-between">
                        ...
                        <div className="h-10 flex flex-row justify-around">
                            <div className="w-10 h-10"><img src="./svgs/c-sharp.svg"/></div>
                            <div className="w-10 h-10"><img src="./svgs/asp.svg"/></div>
                            <div className="w-10 h-10"><img src="./svgs/html.svg"/></div>
                            <div className="w-10 h-10"><img src="./svgs/sql.svg"/></div>
                        </div>
                    </div>
                </div>
                <div className="w-1/3 h-4/5 m-5 border border-1 border-white rounded-2xl overflow-hidden">
                    <img className="w-full content" src="./kmm.jpg" alt="" />
                    <div className="h-1/2 px-5 flex flex-col justify-between">
                        <div>
                        ...
                        <div className="h-10 flex flex-row justify-around">
                            <div className="w-10 h-10"><img src="./svgs/node.svg"/></div>
                            <div className="w-10 h-10"><img src="./svgs/react.svg"/></div>
                            <div className="w-10 h-10"><img src="./svgs/tailwind.svg"/></div>
                            <div className="w-10 h-10"><img src="./svgs/mysql.svg"/></div>
                        </div>
                    </div>
                </div>
                <div className="w-1/3 h-4/5 m-5 border border-1 border-white rounded-2xl overflow-hidden">
                    ...
                    <div className="h-1/2 px-5 flex flex-col justify-between">
                        ...
                        <div className="h-10 flex flex-row justify-around">
                            <div className="w-10 h-10"><img src="./svgs/react.svg"/></div>
                            <div className="w-10 h-10"><img src="./svgs/html.svg"/></div>
                            <div className="w-10 h-10"><img src="./svgs/css.svg"/></div>
                            <div className="w-10 h-10"><img src="./svgs/js.svg"/></div>
                        </div>
                    </div>
                </div>
            </div>
