export function Nav(){
    return (
        <div className="w-full max-w-screen absolute top-0 left-0 pt-5 px-3 flex justify-between items-center"> 
            ...
            <a className="text-base font-medium border border-1 border-white p-3 px-5 rounded-md hover:bg-white hover:text-black" href="dheerajkhatri2003@gmail.com">Contact</a>
        </div>
    )
}